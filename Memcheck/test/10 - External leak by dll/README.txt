...
1) no-info32 - this test was compiled only with the '/MD' flag in x32.
2) with-info32 - this test was compiled with all of the flags in x32.
3) with-info64 - this test was compiled with all of the flags in x64.
